...
const guideSteps: GuideStep[] = [
  {
    ...
    duration: '15 min',
    description: 'Inizia creando il tuo progetto reseller. Compila i dati della società, il tipo di commodity (luce, gas o dual), il mercato target e le regioni operative. Scegli il grossista con cui opererai e imposta le date pianificate.',
    actions: [
      'Clicca "Nuovo Progetto" o usa il Wizard guidato per la creazione rapida',
      'Compila la Scheda Progetto: nome società, commodity, mercato, regioni',
      'Inserisci i dettagli del grossista (nome, contatti, codice ARERA)',
      'Imposta le date chiave: licenza EVE/EVG, go-live pianificato',
  ...
  },
  {
    ...
    actions: [
      ...
      'Controlla che tutte le licenze (EVE/EVG) siano ottenute',
...
const faqResellerData: FAQItem[] = [
  { id: 'reseller-definition', question: "Cos'è un reseller di energia e come si differenzia da un UDD?", answer: "Il RESELLER è un operatore che acquista energia da un grossista (Utente del Dispacciamento - UDD) e la rivende ai clienti finali. L'UDD invece è un operatore che ha rapporti diretti con Terna, GME e i distributori locali, gestendo dispacciamento e bilanciamento. Il reseller opera 'sotto l'ombrello' del grossista, senza accedere direttamente ai mercati all'ingrosso o al Sistema Informativo Integrato (SII).", category: 'reseller' },
  ...
  { id: 'margin-structure', question: "Quali sono i margini tipici sulla vendita di energia?", answer: "Residenziale luce: €6-10/cliente/mese, gas: €10-15/mese. Business: €0,002-0,005/kWh. Margini netti: 30-40% del lordo. Breakeven: 800-1.500 clienti residenziali o 100-200 business.", category: 'financial' },
  // Technical
          ...
          <TabsContent value="faq-app" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Come usare al meglio ogni funzionalità di Power Reseller</CardDescription>
              </CardHeader>
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
                  {faqAppData.map(faq => (
