...
const guideSteps: GuideStep[] = [
  ...
  },
  {
    ...
    subtitle: 'Finanza (Ipotesi, Panoramica, Costi, Margini, Liquidità)',
    image: guideStep4,
    sidebarSection: 'Strategia',
    duration: '45 min',
    description: 'La sezione finanziaria è il motore analitico dell\'app. I margini sono calcolati correttamente sull\'imponibile (al netto IVA). I costi di avvio degli step del processo sono integrati nel cash flow e distribuiti nelle mensilità corrette per un BEP finanziario accurato.',
    actions: [
      'Nella tab "Ipotesi" configura parametri simulazione, canali vendita e costi grossista',
      'In "Panoramica" analizza KPI, margini sull\'imponibile e grafici',
      'Nella tab "Costi" inserisci i costi strutturali e commerciali',
      'Configura i "Canali di Vendita" con commissioni e tassi di attivazione',
      'Analizza i "Margini" (Lordo, Contribuzione, Netto) calcolati sull\'imponibile',
      'Monitora la "Liquidità" con cash flow che include gli investimenti iniziali dagli step',
      'Usa "What-If" per simulare scenari alternativi per canale',
      'Configura i "Flussi Fiscali" (accise, IVA, oneri di sistema)',
    ],
    tips: [
      'I margini sono calcolati sull\'imponibile: l\'IVA è una partita di giro e non influenza la redditività',
      'I costi degli step (investimento iniziale) sono distribuiti nel cash flow per fase',
...
const faqAppData: FAQItem[] = [
  ...
  { id: 'app-profile', question: "Come gestisco il mio profilo utente?", answer: "Nella sezione 'Profilo' della sidebar puoi aggiornare il tuo nome completo e cambiare la password. Il nome viene sincronizzato su tutto il sistema. Per la password, inserisci la nuova password (minimo 6 caratteri) e conferma.", category: 'app' },
  { id: 'app-process', question: "Come funziona la sezione Processo?", answer: "La sezione Processo mostra tutti gli step burocratici necessari, organizzati per fase (Costituzione, Licenze, Operativo, ecc.). Ogni step ha una checklist interattiva, documenti richiesti, costi stimati e date pianificabili. I costi di ogni step vengono integrati automaticamente nel cash flow finanziario, distribuiti nelle mensilità corrette.", category: 'app' },
  { id: 'app-finance', question: "Come uso la sezione Finanza?", answer: "La Finanza ha diverse sotto-sezioni: Ipotesi (parametri simulazione e canali vendita), Panoramica (KPI e grafici), Costi, Ricavi, Margini (calcolati sull'imponibile, al netto IVA), Liquidità (cash flow con investimenti iniziali integrati) e Flussi Fiscali. I dati si integrano automaticamente con Business Plan e Marketing.", category: 'app' },
  { id: 'app-iva-separation', question: "Come vengono calcolati i margini rispetto all'IVA?", answer: "I margini (Lordo, di Contribuzione e Netto) vengono calcolati sull'imponibile, cioè sul fatturato al netto dell'IVA. Questo è il metodo corretto per analizzare la redditività operativa: l'IVA è una partita di giro e non va considerata nel calcolo dei margini. Nelle card e nei grafici vedrai 'sull'imponibile' come riferimento.", category: 'app' },
  { id: 'app-step-costs-cashflow', question: "I costi degli step del processo sono inclusi nel cash flow?", answer: "Sì. I costi inseriti in ogni step del processo (investimenti iniziali) vengono automaticamente distribuiti nel cash flow nelle mensilità corrispondenti alla fase operativa: costituzione al mese 0, licenze ai mesi 1-2, setup tecnico al mese 3, ecc. Questo rende il calcolo del BEP finanziario più accurato.", category: 'app' },
  { id: 'app-simulation', question: "Cos'è la Simulazione Ricavi e come funziona?", answer: "La Simulazione proietta i ricavi su 14 mesi basandosi su parametri reali: contratti mensili acquisiti, consumo medio, PUN, spread, CCV, tasso di attivazione e incasso. Puoi configurare ogni voce tariffaria (trasporto, oneri, accise) e vedere l'impatto sul fatturato. I margini vengono calcolati correttamente sull'imponibile (al netto IVA).", category: 'app' },
  ...
  { id: 'app-error-handling', question: "Cosa succede se qualcosa va storto nell'app?", answer: "L'applicazione utilizza Error Boundaries che catturano gli errori a livello di componente, evitando crash totali. Se una sezione riscontra un problema, vedrai un messaggio di errore con un pulsante 'Riprova' — il resto dell'app continua a funzionare normalmente.", category: 'app' },
